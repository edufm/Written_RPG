...
class Menu:
    ...
    def Exit(): #----------------------------------------------------------------------------------------elegante n ta mas funciona
        EX = int(input("This game does not save game automatically are you sure you want to exit?" "\n" "1 = no" "\n" "2 = maybe"))
        if EX == 1:
            city.city()
...
time.sleep(1)
print("Well that´s getting weird... weapons falling from the sky and a convenient introductory battle...")
time.sleep(1)
