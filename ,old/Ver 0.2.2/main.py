...
class creatures:
    def __init__(self, name, money, vitality, health, endurance, stamina, dexterity, strenght, level, exppoints, weapon, feet, legs, chest, arm, hand, head):
...
#cria criaturas (name, money, vitality, health, endurance, stamina, dexterity,  strenght, level, exppoints, weapon, feet, legs, chest, arm, hand, head)
CR0001 = creatures("Deamon Miner", 50, 40, 40, 40, 40, 100, 50, 1, ran.randint(30,50), WE0236, feet_naked, clothttrousers, chothshirt, arm_naked, hand_naked,head_naked)
CR0002 = creatures("Rock Carrier", 10, 100, 100, 60, 60, 20, 70, 1, ran.randint(30,50), WE0236, feet_naked, clothttrousers, chothshirt, arm_naked, hand_naked,head_naked)
CR0003 = creatures("Mine Leader", 25, 70, 70, 60, 60, 40, 60, 1, ran.randint(30,50), WE0202, feet_naked, clothttrousers, chothshirt, arm_naked, hand_naked,head_naked)
CR0004 = creatures("Great Miner", 40, 80, 80, 60, 60, 20, 80, 1, ran.randint(30,50), WE0236, feet_naked, clothttrousers, chothshirt, arm_naked, hand_naked,head_naked)
