# -*- coding: utf-8 -*-
"""
Created on Thu Apr 14 07:52:31 2016
...
def gameover():
    print("the truth has been hidden forever")
    print("Sorry kid, but you shoudn't try again")
...
sword =  weapons("sword", 7, 7, "slash", 5 , 20, 100, 100, "b", 1)
dagger = weapons("dagger", 4, 1, "piercing", 2 , 10, 25, 25, "b", 1)
hammer = weapons("hammer", 8, 10, "blunt", 6, 40, 200, 200, "b", 1)
pistol = weapons("pistol", 9, 2, "ranged", 60, 100, 50, 50, "b", 1)

#cria roupas iniciais do player name, weight, Type, value, durability, used, quality, defense, enchantment, stackable)
head_naked = armor("head_naked", 0, "Head", 0, -1, -1, "b", 0, "none", 1)
chothshirt =  armor("chothshirt", 0, "Chest", 0, -1, -1,"b", 0, "none", 1)
clothttrousers =  armor("clothttrousers", 0, "Leg", 0, -1, -1, "b", 0, "none", 1)
feet_naked =  armor("feet_naked", 0, "Feet", 0, -1, -1, "b", 0, "none", 1)
arm_naked =  armor("arm_naked", 0, "Arm", 0, -1, -1, "b", 0, "none", 1)
hand_naked =  armor("hand_naked", 0, "Habd", 0, -1, -1, "b", 0, "none", 1)
